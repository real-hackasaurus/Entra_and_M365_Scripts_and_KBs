...
.DESCRIPTION
    ...
    Optional Switches:
    - Set $IncludeRetentionLabelDetails = $true to include details about retention labels applied to the mailbox.
    - Set $IncludeMRMRetentionDetails = $true to include details about MRM retention policies and tags.
    - Set $IncludeRetentionPolicyDetails = $true to include detailed information about retention policies applied to the mailbox.

    Example:
    $IncludeRetentionLabelDetails = $true
    $IncludeMRMRetentionDetails = $true
    $IncludeRetentionPolicyDetails = $true

    Note: Ensure the switches are set before running the script.
