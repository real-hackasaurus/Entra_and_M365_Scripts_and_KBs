...
New-MgInvitation -InvitedUserDisplayName "display name" -InvitedUserEmailAddress wblackwell@nihdev.onmicrosoft.com -InviteRedirectUrl "https://myapplications.microsoft.com" -SendInvitationMessage:$false